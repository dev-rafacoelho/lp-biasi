      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="relative h-[900px] rounded-2xl overflow-hidden shadow-xl">
              <Image
                src="/local.jpg"
                alt="Escritório Biasi Negócios Imobiliários"
                fill
          ...
          <div className="order-1 lg:order-2">
            <div className="bg-white rounded-2xl p-8 shadow-lg h-[900px] flex flex-col">
              ...
              <div className="space-y-6 mb-8 flex-shrink-0">
                <div className="flex items-start">
                  <div className="flex-shrink-0 w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mr-4">
                    <svg className="w-6 h-6 text-[#014ab1]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="relative flex-1 rounded-lg overflow-hidden">
                <Image
                  src="/mapa.png"
                  alt="Interior do escritório Biasi"
                  fill
